...
आपको AsciiDoc सिंटैक्स पर https://raw.githubusercontent.com/arduino/reference-hi/master/AsciiDoc_sample/AsciiDoc_Dictionary/AsciiDoc_Template-Dictionary.adoc[reference-hin/AsciiDoc_sample/AsciiDoc_Dictionary] में एक अवलोकन मिलेगा।  इसमें टाइटल, टेक्स्ट, लिंक, इमेज, टेबल्स, कोड और विभिन्न एम्बेड (वीडियो, स्लाइड शो, ऑडियो और कोड) शामिल हैं। आप इसे https://www.arduino.cc/reference/en/asciidoc_sample/asciidoc_dictionary/asciidoc_template-dictionary/[यहाँ प्रस्तुत देख सकते हैं]।
